<template>
  <div class="relative">
    <svg class="absolute top-1/2 -translate-y-1/2 text-onSurface left-4" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
    ...
    <input ref="input" :placeholder="isDocs ? 'Cari tahu tentang suatu API' : 'Temukan artikel yang kamu cari'" type="search"
           class="bg-surfaceContainer placeholder-onSurfaceVariant rounded-full focus:ring-2 focus:ring-primary outline-none w-full py-4 pl-12"
    >
  </div>
</template>
